...
void WCanvas::onCreateEx(LPVOID lpVoid) 
{
	...
	idealRect.Set(verticalSBChild->posOffsets.x, verticalSBChild->posOffsets.y, verticalSBChild->posOffsets.w, verticalSBChild->posOffsets.h);
	...
	wndRect.X = m_iLeft; wndRect.Y = m_iTop; wndRect.Width = getWidth(); wndRect.Height = getHeight();
	idealRect.Set(horizontalSBChild->posOffsets.x, horizontalSBChild->posOffsets.y, horizontalSBChild->posOffsets.w, horizontalSBChild->posOffsets.h);
	...
	if(bHasClientArea) 
	{
		...
		RectF destRect;
		wndRect.X = m_iLeft; wndRect.Y = m_iTop; wndRect.Width = getWidth(); wndRect.Height = getHeight();
		idealRect.Set(clientArea->posOffsets.x, clientArea->posOffsets.y, clientArea->posOffsets.w, clientArea->posOffsets.h);
