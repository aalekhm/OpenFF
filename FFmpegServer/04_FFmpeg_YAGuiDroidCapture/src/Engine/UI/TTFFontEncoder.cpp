...
void TTFFontEncoder::exportData(	const char* ttfFileName, 
									int iFontSize, 
									int iFontDPI, 
									Glyph* glyphArray, 
									int iSize, 
									...
									int iMaxGlyphHeight) 
{
	...
	sFileNameStream << "_" << iFontSize << "_" << iFontDPI << "DPI";
	sFileNameNoExt += sFileNameStream.str().c_str();
	sFileNameNoExt += ".dat";
...
void TTFFontEncoder::renderBitmapToMemory(	unsigned char* dstBitmap, 
											int x, 
											int y, 
											int dstWidth, 
...
void TTFFontEncoder::exportToFile(	const char* ttfFileName, 
									int iFontSize, 
									int iFontDPI, 
									int iImageWidth, 
									int iImageHeight, 
...
void TTFFontEncoder::exportToPGM(	const char* ttfFileName, 
									int iFontSize, 
									int iFontDPI, 
									int iImageWidth, 
									int iImageHeight, 
									unsigned char* imageBuffer) 
{
	...
	if(bCanWrite) 
	{
		sFileNameStream.clear();
		sFileNameStream << "P5 " << iImageWidth << " " << iImageHeight << " " << 255 << "\n";
		rafOut->writeBytes(sFileNameStream.str().c_str());
...
void TTFFontEncoder::exportToTGA(	const char* ttfFileName, 
									int iFontSize, 
									int iFontDPI, 
									int iImageWidth, 
									int iImageHeight, 
