...
struct WWidgetManager 
{
	public:
		...
		static H_WND				addComponentFromWidget(	std::string sComponentClass, 
															...
															HMENU hMenu, 
															LPVOID lpVoid,
															std::function<void(CHILD* pChildWidget, RectF destRect, RectF& childRect)> fChildRectCallable);
		...
		static RectF				getDestinationRectFromWidgetForChild(std::string sWidget, std::string sChild, RectF wndRect);
		static RectF				getDestinationClientRectFromWidget(std::string sParentWidget, RectF wndRect);
		static void					getClientRectFromWidget(RectF& destRect, std::string sParentWidget, RectF wndRect);
	...
	private:
		...
		void						initOrthogonalMatrix(int32_t iScreenWidth, int32_t iScreenHeight);

		bool						compileShaderFromFile(GLenum iShaderType, const char* sShaderFile, GLuint& iShaderID);
		bool						compileShader(GLenum iShaderType, const char* sShaderSource, GLuint& iShaderID);
		bool						checkCompileErrors(GLuint iShaderID, std::string sType);
